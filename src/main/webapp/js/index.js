...
!function () {
    if (!document._sufei_data2) {
        ...
        var t, r = "isg", e = [/\.alicdn\.com\//, /\.mmstat\.com/, /\.tanx\.com/], i = !!window.addEventListener, o = document.head || document.getElementsByTagName("head")[0];
        !function (n) {
            function t() {
                return 4294967295 * Math.random() >>> 0
            }
            ...
            function s(n, t, r) {
                if (!g)return !1;
                var e = g(n, t);
                return e && e.set ? (e.set = r(e.set), Object.defineProperty(n, t, e), !0) : !1
            }
        ...
        !function (n) {
            ...
            n.A = A;
            var x = navigator.userAgent, B = navigator.vendor, j = "chrome" in window, W = "ActiveXObject" in window, D = o.style, O = [function () {
        ...
        !function (n) {
            ...
            function u() {
                t.k(window, "fetch", function (n) {
                    return function (t, r) {
                        var e = w.H(t);
                        return e ? t = e : (r = r || {}, r.credentials = r.credentials || "include"), n.call(this, t, r)
                    }
                })
            }
        ...
        !function (n) {
            function i(n) {
                var t = e, r = window.sufei_jsonp_ignore;
                r && (t = t.concat(r));
