var config = function (version, configParam) {
    ...
    if(config.debug === !0){
        customerConfig.base = config.base || "../../js";
        customerConfig.comboExcludes = /.*/;
        return customerConfig;
    }else{
        if(-1 != hostName.indexOf("m.taobao.com") || -1 != hostName.indexOf("wapa.taobao.com")){
            customerConfig.base = "//g.alicdn.com/tb/auctionh5/" + version;
        }else{
            customerConfig.base = "//g-assets.daily.taobao.net/tb/auctionh5/" + version;
        }

        customerConfig.alias = {
    ...
    return config.debug === !0  ?
        (customerConfig.base = config.base || "../../js", customerConfig.comboExcludes = /.*/) :
        customerConfig.base = -1 != hostName.indexOf("m.taobao.com") || -1 != hostName.indexOf("wapa.taobao.com") ?
