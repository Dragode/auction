!function ($, window) {
    ...
    $.fn.util = function () {
        ...
        show: function (a, b) {
            ...
            a ? this.show(a, b) : this.show("网络错误，请稍后再试", b)
        ...
        isInTaobaoClient: function (a, b) {
            ...
            return $.deviceUtil.isAndroid() && /@taobao_android_/i.test(window.navigator.userAgent)
        }, isIosShoutao: function () {
            return $.deviceUtil.isIphone() && /@taobao_iphone_/i.test(window.navigator.userAgent)
        }
    }, $.fn.lazyLoadUtil = {
